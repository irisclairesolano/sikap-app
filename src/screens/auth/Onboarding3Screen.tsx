...
type Onboarding3ScreenNavigationProp = NativeStackNavigationProp<AuthStackParamList, 'Onboarding3'>;
      ...
      <View style={styles.middle}>
        <View style={styles.centerBlock}>
          ...
          <View style={styles.textContent}>
            <Text style={styles.title}>Connect & Get Hired</Text>
            <Text style={styles.description}>
              Employers find you, negotiate, and confirm your hire safely through the app.
            </Text>
          </View>
        </View>
      </View>
