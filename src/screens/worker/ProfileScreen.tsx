        ...
        <View style={styles.profileHeader}>
          ...
          <View style={styles.profileInfo}>
            <View style={styles.nameRow}>
              ...
              {worker.verified && <Ionicons name="checkmark-circle" size={18} color={colors.mintDeep} />}
            </View>
          ...
          <View style={styles.reputationRow}>
            ...
            <View style={styles.reputationStars}>
              <View style={styles.starsRow}>
                {[1, 2, 3, 4, 5].map((star) => (
                  <Ionicons key={star} name="star" size={14} color={star <= Math.round(worker.reputation) ? colors.gold : colors.inkFaint} />
                ))}
              </View>
...
const styles = StyleSheet.create({
  ...
  reputationEyebrow: { fontFamily: fonts.bodyBold, fontSize: 11, color: colors.primaryDark, textTransform: 'uppercase', letterSpacing: 1 },
  ...
  reputationTagline: { fontFamily: fonts.displayItalic, fontSize: 14, color: colors.primaryDark, marginTop: 8 },
  ...
  sectionEyebrow: { fontFamily: fonts.bodyBold, fontSize: 12, color: colors.inkSoft, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 10 },
  skillsList: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  chip: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingVertical: 8, paddingHorizontal: 12, borderRadius: 20 },
